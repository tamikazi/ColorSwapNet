...
from models.models_seg.resnet import resnet18, resnet50, resnet101
from functools import partial

sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..')))

from utils.constants import DEVICE, FC_DIM_SEG, NUM_CLASSES
...
def build_encoder(path_encoder_weights="", encoder_model="resnet101-dilated"):
    """
...
def build_decoder(path_decoder_weights=""):
    ...
    """
    net_decoder = PPM(num_class=NUM_CLASSES, fc_dim=FC_DIM_SEG)
