...
class BaseDataset(torch.utils.data.Dataset):
    def __init__(self, image_root, annotation_root, split='training', **kwargs):
        ...
        self.imgSizes = IMG_SIZES_SEG
        self.imgMaxSize = IMG_MAX_SIZE_SEG
        self.padding_constant = PADDING_SEG
...
class TrainDataset(BaseDataset):
    def __init__(self, root_dataset, image_root, annotation_root, batch_per_gpu=1, **kwargs):
        ...
        self.segm_downsampling_rate = SEGM_DOWNSAMPLING_RATE_SEG
        self.cur_idx = 0
